...
def getUUID():
	...
	pm = re.search(regx, data.decode()) #.decode()
...
def webwxinit():
	...
	request = urllib.request.Request(url = url, data = json.dumps(params, ensure_ascii=False).encode(encoding='UTF8')) #.encode(encoding='UTF8')
